...
function init() {
    ...
    //Camera
    camera = new THREE.PerspectiveCamera(35, window.innerWidth / window.innerHeight, 0.1, 30000);
...
function calcRatio() {
    ...
    camera.rotation.set(cameraAttr.startAngleX, cameraAttr.startAngleY, cameraAttr.startAngleZ);
...
function makeBackground() {
    ...
    space = new THREE.Mesh(new THREE.SphereBufferGeometry(100, 100, 100), equirectMaterial);
